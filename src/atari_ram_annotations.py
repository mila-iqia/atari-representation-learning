...
#                             colOpponents = range(27,34)),
    ...
    "venture": dict(sprite0_Ypos        = 20,  
                    ...
                    ballXpos = 85,
                    ballYpos = 26,    
                    sprite0_dir_speed            = 28,# The direction and speed of each game object_  The upper nybble is the
                    sprite1_dir_speed            = 29,   # direction, and it corresponds to the values generated by a joystick_
                    sprite2_dir_speed      = 30,   # The 3 lowest order bits hold the object's speed 0 - 7_  0 is immobile        
                    sprite3_dir_speed      = 31,  # like an item_  7 is the quickest speed in the game_
                    sprite4_dir_speed      = 32,
                    sprite5_dir_speed      = 33,
                    ball_dir_speed            = 34,
...
from src.atari_ram_annotations import atari_dict
...
relative_position_keys = [k for k in all_keys if k in nonlocalization_pos or "arm" in k]
...
count_display_keys = clock_keys + count_keys + meter_keys

existence_keys = [k for k in remaining_keys if "bit_map" in k  or "rope" in k ]
[remaining_keys.remove(k) for k in meter_keys + existence_keys + relative_position_keys if k in remaining_keys];
