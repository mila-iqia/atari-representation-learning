...
#                             colOpponents = range(27,34)),
    ...
    "venture": dict(sprite0_y        = 20,  
                    ...
                    missile_x = 85,
                    missile_y = 26,    
                    sprite0_direction_speed            = 28,# The direction and speed of each game object_  The upper nybble is the
                    sprite1_direction_speed            = 29,   # direction, and it corresponds to the values generated by a joystick_
                    sprite2_direction_speed      = 30,   # The 3 lowest order bits hold the object's speed 0 - 7_  0 is immobile        
                    sprite3_direction_speed      = 31,  # like an item_  7 is the quickest speed in the game_
                    sprite4_direction_speed      = 32,
                    sprite5_direction_speed      = 33,
                    missile_direction_speed            = 34,
